...
<body>
  ...
  <script>
    ...
    let downloadId=null, timerId=null, lastFileName='';
    let lastFormat = "mp3";
...
def fetch_video_title(url, fmt, mp3quality, mp4quality):
    try:
...
def index():
    if request.method == "POST":
        ...
        title, ext = fetch_video_title(url, fmt, mp3quality, mp4quality)
        safe_title = title
        ...
        return jsonify({"download_id": download_id, "title": safe_title, "extension": ext})
